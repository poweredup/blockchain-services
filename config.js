...
exports.mongodb = {
  uri: process.env.MONGODB_URI || process.env.MONGOHQ_URL || 'mongodb://localhost:27017/turboplay'
};
...
exports.paymentContractAddress = require('./truffle/build/contracts/TurboPlayPayment.json').networks[networkId].address;
